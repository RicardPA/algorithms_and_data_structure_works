...
// identificar     
    printf ( "%s\n", "\nExemplo0117 - Programa = v1.7" );     
    printf ( "%s\n", "Autor: Ricado Portilho de Andrade" );     
    printf ( "\n" ); // mudar de linha 

//programa 

printf("Digite o tamanho de um dos lados do cubo:");
scanf("%lf", &x); //lado
 
double y = pow((x/4),3);   //descubrir o valor do volume de um cubo com um quarto da medida do lado 

printf("\nO volume de um cubo com um quarto da medida do lado dado e' %lf\n", y);
