...
double a = (x*(y/2));   //decubrir a area de um retangulo com a metade da altura 


printf("\nA area de um retangulo com a metade da altura do mesmo e' %lf\n", a);
