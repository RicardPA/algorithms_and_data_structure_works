...
int y = ((x*2)*(x*2));  //area do quadrado 
int z = ((x*2)+(x*2)+(x*2)+(x*2));  //perimetro do quadrado

printf("\nA area de um quadrado com o dobro do tamanho dos lados e' igual a %d\n", y);
printf("\nO perimetro de um quadrado com o dobro do tamanho dos lados e' igual a %d\n", z);
