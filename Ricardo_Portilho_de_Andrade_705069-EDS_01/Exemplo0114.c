...
int a = (x*y*4);   //decubrir a area de um retangulo com o dobro do tamanho dos lados 
int b = ((x*2+y*2)*2);   //perimetro do retangulo com o drobo do tamanho dos lados

printf("\nA area de um retangulo com o dobro do tamanho da base e da altura e' %d\n", a);
printf("\nO perimetro de um retangulo com o dobro do tamanho da base e da altura e' %d\n", b);
