...
// definir dado
double x = 0;//largura 
double y = 0;//comprimento
double z = 0;//altura

// identificar     
    printf ( "%s\n", "\nExemplo0118 - Programa = v1.8" );     
    printf ( "%s\n", "Autor: Ricado Portilho de Andrade" );     
    printf ( "\n" ); // mudar de linha 

//programa 

printf("Digite o tamanho da largura do paralelepipedo:");
scanf("%lf", &x); //largura

printf("\nDigite o tamanho da altura do paralelepipedo:");
scanf("%lf", &y); //altura

printf("\nDigite o tamanho do comprimento do paralelepipedo:");
scanf("%lf", &z); //comprimento
 
double v = ((x/2)*(y/2)*(z/2));   //descubrir o valor do volume do paralelepipedo com metade dos valores   

printf("\nO volume de um paralelepipedo com metade dos valores das medidas e' %lf\n", v);
...
1.2       (OK)      01.      *Um valor inteiro e' inserido e e' tratado como um lado de um quadrado, depois o valor e' mutiplicado por dois  e e' dado a area e perimetro. 
...
1.4       (OK)      01.      *Dois valores sao inseridos e sao tratados como base e altura de um retangulo, depois os valores sao mutiplicados por dois e e' dado a area e o perimetro.
1.5       (OK)      01.      *Dois valores reais sao inseridos e sao tratados como base e altura de um retangulo, o valor referente a altura e' dividido por dois e e' dado a area e o perimetro.
1.6       (OK)      01.      *Um valor e' dado e e' tratado como um lado de um triangulo equilatero, depois os valores referentes ao perimetro, area e altura sao entregues.  
...
VERSAO: 1.4
a.) 4 e 5           RESULTADO: Os valores entregues sao iguais a 80 e 36 
// Obs: Testei todos os valores acima e nao ocorreu erros na execucao dos mesmos.

VERSAO: 1.5
a.) 5.5 e 6.6           RESULTADO: O valor entregue e' igual a 18.15 
// Obs: Testei todos os valores acima e nao ocorreu erros na execucao dos mesmos.

VERSAO: 1.6
a.) 4           RESULTADO: Os valores entregues sao iguais a 12.000000, 6.928203 e 3.464102
// Obs: Testei todos os valores acima e nao ocorreu erros na execucao dos mesmos.

VERSAO: 1.7
a.) 8           RESULTADO: O valor entregue e' igual a 8.000000
// Obs: Testei todos os valores acima e nao ocorreu erros na execucao dos mesmos.

VERSAO: 1.8
a.) 4, 8 e 6           RESULTADO: O valor entregue e' igual a 24.000000
// Obs: Testei todos os valores acima e nao ocorreu erros na execucao dos mesmos.
...
1.4      17/03    utilizacao de bibliotecas da propria linguagem.
1.5      17/03    utilizacao de bibliotecas da propria linguagem.
1.6      20/03    utilizacao de bibliotecas da propria linguagem.
...
---------------------------------------------- testes 
 ...
 1.4      01. ( OK )           entrada e saida de valores inteiros.
 1.5      01. ( OK )           entrada e saida de valores reais.
 1.6      01. ( OK )           entrada e saida de valores reais.
