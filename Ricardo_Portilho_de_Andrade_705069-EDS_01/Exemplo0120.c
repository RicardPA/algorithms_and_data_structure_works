...
1.3       (OK)      01.      *Dois valores sao inseridos e sao tratados como lados de um retangulo, depois e' dado o valor da terca parte da area do retangulo.
1.4       (OK)      01.      *Dois valores sao inseridos e sao tratados como lados de um retangulo, depois os valores sao mutiplicados por dois e e' dado a area e o perimetro.
