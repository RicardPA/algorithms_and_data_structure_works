...
// identificar     
    printf ( "%s\n", "\nExemplo0116 - Programa = v1.6" );     
    printf ( "%s\n", "Autor: Ricado Portilho de Andrade" );     
    printf ( "\n" ); // mudar de linha 

//programa 

printf("Digite o tamanho de um dos lados do triangulo equilatero:");
scanf("%lf", &x); //lado
 
double y = sqrt(pow(x,2)-pow((x/2),2));   //decubrir a altura de um retangulo com a metade da altura 
double a = ((x*y)/2);   //decubrir a area de um triangulo equilatero 
double z = (x*3);   //decubrir a perimetro de um triangulo equilatero


printf("\nA area do triangulo equilatero e' %lf\n", a);
printf("\nO perimetro do triangudo equilareto e' %lf\n", z);
printf("\nA altura do triangulo equilatero e' %lf\n", y);
