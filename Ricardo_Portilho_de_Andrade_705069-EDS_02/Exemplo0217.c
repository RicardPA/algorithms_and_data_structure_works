...
{ 
 ...
 // ler do teclado     
   ...
   y = IO_readint ( "Entrar com outro inteiro: " );
 ...
 // testar valor     
  ...
  if (x > 0)
  {
   if(a==0)
   {
     IO_printf ( "%s (%d)\n", "O primeiro valor e' par e positivo", x );
   }  
   else
   {
     IO_printf ( "%s (%d)\n", "O primeiro valor e' impar e positivo", x );
   } 
  }
  ...
  else if (x < 0)
  {
   if(a==0)
   {
     IO_printf ( "%s (%d)\n", "O primeiro valor e' par e negativo", x );
   }  
   else
   {
     IO_printf ( "%s (%d)\n", "O primeiro valor e' impar e negativo", x );
   } 
  }
  ...
  if (y > 0)
  {
   if(b==0)
   {
     IO_printf ( "%s (%d)\n", "O segundo valor e' par e positivo", y );
   }  
   else
   {
     IO_printf ( "%s (%d)\n", "O segundo valor e' impar e positivo", y );
   } 
  }
  ...
  else if (y < 0)
  {
   if(b==0)
   {
     IO_printf ( "%s (%d)\n", "O segundo valor e' par e negativo", y );
   }  
   else
   {
     IO_printf ( "%s (%d)\n", "O segundo valor e' impar e negativo", y );
   } 
  }
