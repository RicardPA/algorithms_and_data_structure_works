...
{ 
 ...
 // testar valor     
    ...
    if((a==0) && (b==0))
    {
     IO_printf ( "%s (%d)\n", "O primeiro valor e' par", x );
     IO_printf ( "%s (%d)\n", "O segundo valor nao e' impar", y );
    }
    
    if((a>0) && (b>0))
    {
     IO_printf ( "%s (%d)\n", "O primeiro valor nao e' par", x );
     IO_printf ( "%s (%d)\n", "O segundo valor e' impar", y );
    }
